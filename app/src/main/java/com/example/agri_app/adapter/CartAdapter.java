...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> {
    ...
    public CartAdapter(List<CartVO> list) { this.cartList = list; }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvName.setText(c.productName);
        holder.tvPrice.setText("￥" + c.price);
        holder.tvQuantity.setText("x " + c.quantity);
    }

    @Override
    public int getItemCount() { return cartList == null ? 0 : cartList.size(); }
